...
<Project Type="Project" LVVersion="15008000">
	...
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="SubVI&apos;s" Type="Folder">
			<Item Name="ADFX_Do_Save.vi" Type="VI" URL="../subvis/ADFX_Do_Save.vi"/>
			<Item Name="ADFX_Do_Load.vi" Type="VI" URL="../subvis/ADFX_Do_Load.vi"/>
			<Item Name="ADFX_Ensure_Save.vi" Type="VI" URL="../subvis/ADFX_Ensure_Save.vi"/>
		...
		<Item Name="Project Documentation" Type="Folder">
			<Item Name="Documentation Images" Type="Folder">
				<Item Name="Adafruit_FX.ico" Type="Document" URL="../documentation/Adafruit_FX.ico"/>
				...
				<Item Name="Banner.bmp" Type="Document" URL="../documentation/Banner.bmp"/>
				<Item Name="Welcome screen.bmp" Type="Document" URL="../documentation/Welcome screen.bmp"/>
			</Item>
			<Item Name="GNU Lesser General Public License 3 - English.rtf" Type="Document" URL="../documentation/GNU Lesser General Public License 3 - English.rtf"/>
			<Item Name="readme.rtf" Type="Document" URL="../documentation/readme.rtf"/>
		</Item>
		<Item Name="Type Definitions" Type="Folder">
			<Item Name="Adafruit_RX_Programmer.rtm" Type="Document" URL="../controls/Adafruit_RX_Programmer.rtm"/>
			<Item Name="AFXP Data.ctl" Type="VI" URL="../controls/AFXP Data.ctl"/>
			<Item Name="AFXP State.ctl" Type="VI" URL="../controls/AFXP State.ctl"/>
			<Item Name="AFCP Setup.ctl" Type="VI" URL="../controls/AFCP Setup.ctl"/>
		</Item>
		<Item Name="AFXP Main.vi" Type="VI" URL="../AFXP Main.vi"/>
		...
		<Item Name="Build Specifications" Type="Build">
			<Item Name="Adafruit FX Programmer" Type="EXE">
				...
				<Property Name="TgtF_companyName" Type="Str">TangibleTec, LLC</Property>
				<Property Name="TgtF_fileDescription" Type="Str">Adafruit FX Programmer is a simple file manager for the Adafruit Audio FX Sound-boards: https://learn.adafruit.com/adafruit-audio-fx-sound-board</Property>
				<Property Name="TgtF_internalName" Type="Str">Adafruit FX Programmer</Property>
				<Property Name="TgtF_legalCopyright" Type="Str">MIT License 2016</Property>
				<Property Name="TgtF_productName" Type="Str">Adafruit FX Programmer</Property>
				<Property Name="TgtF_targetfileGUID" Type="Str">{A9B9C488-ADD7-40F6-AAC2-547427E5CB24}</Property>
				<Property Name="TgtF_targetfileName" Type="Str">Adafruit FX Programmer.exe</Property>
			</Item>
			<Item Name="Setup" Type="Installer">
				<Property Name="Destination[0].name" Type="Str">TangibleTec</Property>
				<Property Name="Destination[0].parent" Type="Str">{3912416A-D2E5-411B-AFEE-B63654D690C0}</Property>
				<Property Name="Destination[0].tag" Type="Str">{532F8840-F9EC-4E94-9142-8EA7934F1715}</Property>
				<Property Name="Destination[0].type" Type="Str">userFolder</Property>
				<Property Name="Destination[1].name" Type="Str">Adafruit_FX_Programmer</Property>
				<Property Name="Destination[1].parent" Type="Str">{532F8840-F9EC-4E94-9142-8EA7934F1715}</Property>
				<Property Name="Destination[1].tag" Type="Str">{D5CED728-8E9D-4BAD-9196-BBDF4F25C830}</Property>
				<Property Name="Destination[1].type" Type="Str">userFolder</Property>
				<Property Name="DestinationCount" Type="Int">2</Property>
				<Property Name="DistPart[0].flavorID" Type="Str">DefaultFull</Property>
				<Property Name="DistPart[0].productID" Type="Str">{9BF41E88-9689-42A4-BD50-56F2280B97F0}</Property>
				<Property Name="DistPart[0].productName" Type="Str">NI LabVIEW Runtime 2015 SP1</Property>
				...
				<Property Name="INST_productName" Type="Str">Adafruit_FX_Programmer</Property>
				<Property Name="INST_productVersion" Type="Str">1.0.9</Property>
				<Property Name="INST_readmeID" Type="Ref">/My Computer/Project Documentation/readme.rtf</Property>
				<Property Name="InstSpecBitness" Type="Str">32-bit</Property>
				<Property Name="InstSpecVersion" Type="Str">15018004</Property>
				<Property Name="MSI_arpCompany" Type="Str">TangibleTec, LLC</Property>
				<Property Name="MSI_arpContact" Type="Str">support@tangibletec.com</Property>
				<Property Name="MSI_arpURL" Type="Str">http://www.tangibletec.com</Property>
				<Property Name="MSI_autoselectDrivers" Type="Bool">true</Property>
				<Property Name="MSI_bannerImageID" Type="Ref">/My Computer/Project Documentation/Documentation Images/Banner.bmp</Property>
				<Property Name="MSI_distID" Type="Str">{BD654EC0-63DA-475F-8489-6195287C0405}</Property>
				<Property Name="MSI_hideNonRuntimes" Type="Bool">true</Property>
				<Property Name="MSI_licenseID" Type="Ref">/My Computer/Project Documentation/GNU Lesser General Public License 3 - English.rtf</Property>
				<Property Name="MSI_osCheck" Type="Int">0</Property>
				<Property Name="MSI_upgradeCode" Type="Str">{4D42C3C2-60A1-4E92-A92F-640A4208F56D}</Property>
				<Property Name="MSI_welcomeImageID" Type="Ref">/My Computer/Project Documentation/Documentation Images/Welcome screen.bmp</Property>
				<Property Name="MSI_windowMessage" Type="Str">This will install the Adafruit FX Programmer, a simple file manager for the Adafruit Audio FX Sound Board.
https://learn.adafruit.com/adafruit-audio-fx-sound-board</Property>
				<Property Name="MSI_windowTitle" Type="Str">Installer for Adafruit FX Programmer</Property>
				<Property Name="RegDest[0].dirName" Type="Str">Software</Property>
				<Property Name="RegDest[0].dirTag" Type="Str">{DDFAFC8B-E728-4AC8-96DE-B920EBB97A86}</Property>
				<Property Name="RegDest[0].parentTag" Type="Str">2</Property>
				<Property Name="RegDestCount" Type="Int">1</Property>
				<Property Name="Source[0].dest" Type="Str">{532F8840-F9EC-4E94-9142-8EA7934F1715}</Property>
				<Property Name="Source[0].File[0].dest" Type="Str">{532F8840-F9EC-4E94-9142-8EA7934F1715}</Property>
				<Property Name="Source[0].File[0].name" Type="Str">Adafruit FX Programmer.exe</Property>
				<Property Name="Source[0].File[0].Shortcut[0].destIndex" Type="Int">0</Property>
				<Property Name="Source[0].File[0].Shortcut[0].name" Type="Str">Adafruit_FX_Programmer</Property>
				...
				<Property Name="Source[0].name" Type="Str">Adafruit FX Programmer</Property>
				<Property Name="Source[0].tag" Type="Ref">/My Computer/Build Specifications/Adafruit FX Programmer</Property>
